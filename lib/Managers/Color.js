...
class Color {
  ...
  static style(options, text) {
    if (!util.isObject(options)) return new Error(`The settings must be an Object, not ${typeof options}.`);
    else if (typeof text !== 'string') return new Error(`The text must be a String, not ${typeof text}.`);
   ...
   */
  static rainbow(text) {
    if (typeof text !== 'string') return new Error(`The text must be a String, not ${typeof text}.`);
