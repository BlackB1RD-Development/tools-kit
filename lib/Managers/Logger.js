  ...
  static important(...args) {
    ...
    const settings = {
      ...
      options: {
        ...
        format: options && options.format ? options.format : options.options && options.options.format ? options.options.format : (options) => {
          return !options.time && !options.tag ? options.content : !options.time ? `[${options.tag}]: ${options.content}` : !options.tag ? `[${options.time}]: ${options.content}` : `[${options.time} | ${options.tag}]: ${options.content}`;
        }
      },
      args: content
    ...
    const settings = {
      ...
      log: {
        ...
        options: {
          ...
          format: options && options.format ? options.format : options.options && options.options.format ? options.options.format : options.log && options.log.format ? options.log.format : (options) => {
            return !options.time && !options.tag ? options.content : !options.time ? `[${options.tag}]: ${options.content}` : !options.tag ? `[${options.time}]: ${options.content}` : `[${options.time} | ${options.tag}]: ${options.content}`;
          }
        },
        args: content
